...
export const HowItWorks = [
    ...
    { label: "Personalized Recommendations", description: "IReceive tailored solvent suggestions that prioritize eco-friendly, low-toxicity ionic liquids, offering cost-effective and sustainable solutions."},
